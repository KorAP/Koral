...
public class CQPQueryProcessorTest extends BaseQueryTest {
	...
	result = mapper.readTree(qs.toJSON());
        ...
        assertEquals("type:string", result.at("/query/wrap/type").asText());
        assertEquals("flags:caseInsensitive", result.at("/query/wrap/flags/0").asText());
        assertEquals("flags:diacriticsInsensitive", result.at("/query/wrap/flags/1").asText());
    ...
    public void testPositionsSpan () throws JsonProcessingException, IOException {
     ...
     //   assertEquals("frames:endsWith", res.at("/query/frames/2").asText());
        ...
        // []
        assertEquals("koral:token", result.at("/query/operands/1/operands/2/@type").asText());
        assertTrue(result.at("/query/operands/1/operands/2/wrap/key").isMissingNode());
        // cuminte
        assertEquals("koral:token", result.at("/query/operands/1/operands/3/@type").asText());
        assertEquals("cuminte", result.at("/query/operands/1/operands/3/wrap/key").asText());
        
        //[]*
        assertEquals("koral:group", result.at("/query/operands/1/operands/4/@type").asText());
        assertEquals("operation:repetition", result.at("/query/operands/1/operands/4/operation").asText());
        assertEquals("koral:token", result.at("/query/operands/1/operands/4/operands/0/@type").asText());
        ...
        assertEquals("np", result.at("/query/operands/0/wrap/key").asText());
        assertEquals("koral:token", result.at("/query/operands/1/operands/0/operands/0/@type").asText());
        assertEquals(1, result.at("/query/operands/1/operands/0/boundary/min").asInt());
        assertEquals("operation:repetition", result.at("/query/operands/1/operands/0/operation").asText());
        assertEquals("koral:group", result.at("/query/operands/1/operands/1/@type").asText());
        assertEquals("operation:repetition", result.at("/query/operands/1/operands/1/operation").asText());
        assertEquals("operation:sequence", result.at("/query/operands/1/operands/1/operands/0/operation").asText());
        assertEquals("JJ.*", result.at("/query/operands/1/operands/1/operands/0/operands/0/wrap/key").asText());
        assertEquals("1", result.at("/query/operands/1/operands/1/operands/0/operands/1/boundary/min").asText());
