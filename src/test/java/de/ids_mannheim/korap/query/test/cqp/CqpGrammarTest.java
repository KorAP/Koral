...
public class CqpGrammarTest {
    ...
    public void testNegTermGroup () {
    	 	 ...
    	 	 assertEquals(
    	 	 "(request (query (segment (token [ (termGroup (term ( (term (layer lemma) (termOp =) (key (regex \"go\"))) )) (boolOp &) (termGroup ! ( (termGroup (term (layer word) (termOp =) (key (regex \"went\")) (flag %c)) (boolOp |) (term (layer word) (termOp =) (key (regex \"gone\")) (flag %c))) ))) ]))) ;)", 
...
//this will fail because spanclass can only be used with tokens!!
    ...
    public void testMU1 () {
    	 	...
    	 	assertEquals( 
    		"(request (query (segment (matching MU ( (meetunion meet (segment (token (key (regex \"in\")))) ( (meetunion meet (segment (token (key (regex \"due\")))) (segment (token (key (regex \"course\")))) 1 1) ) 1 1) )))) ;)",
    ...
    public void testMU2 () {
    	 	...
    	 	assertEquals( 
    	 	"(request (query (segment (matching MU ( (meetunion meet (segment (token (key (regex \"in\")))) ( (meetunion meet (segment (emptyTokenSequence (emptyToken [ ]))) (segment (token (key (regex \"course\")))) 1 1) ) 1 1) )))) ;)",
    ...
    public void testMU3 () {
    	 	...
    	 	assertEquals( 
    		"(request (query (segment (matching MU ( (meetunion meet ( (meetunion meet (segment (token (key (regex \"course\")))) (segment (token (key (regex \"due\")))) -1 -1) ) (segment (token (key (regex \"in\")))) -2 -2) )))) ;)",
    ...
    public void testMU4 () {
    	 	...
    	 	assertEquals( 
    		"(request (query (segment (matching MU ( (meetunion meet ( (meetunion meet (segment (token [ (term (layer pos) (termOp =) (key (regex \"NN.*\"))) ])) (segment (token (key (regex \"virtue\")))) 2 2) ) (segment (token (key (regex \"of\")))) 1 1) )))) ;)",
    ...
    public void testMU5 () {
    	 	...
    	 	assertEquals( 
    		"(request (query (segment (matching MU ( (meetunion meet ( (meetunion meet (segment (token (key (regex \"one\")))) (segment (token (key (regex \"hand\")))) 1 1) ) ( (meetunion meet (segment (token (key (regex \"other\")))) (segment (token (key (regex \"hand\")))) 1 1) ) s) )))) ;)",
    ...
    public void testMUinS () {
    	 	...
    	 	assertEquals( 
    		"(request (query (segment (matching MU ( (meetunion meet (segment (token (key (regex \"tea\")) (flag %c))) (segment (token (key (regex \"cakes\")) (flag %c))) s) )))) ;)",
